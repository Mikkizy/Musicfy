...
import com.lord_ukaka.musicapp.other.Constants.NETWORK_ERROR
import com.lord_ukaka.musicapp.other.Event
...
class MusicServiceConnection(
    ...
    //This is used to get transport control the songs, like pause, play and execute callbacks
    ...
    //The reason for using a getter function here is because the mediaController has not been instantiated yet.
    val transportControls: MediaControllerCompat.TransportControls
        get() = mediaController.transportControls

    //This function is to subscribe to and unsubscribe from a mediaId
        ...
        override fun onSessionEvent(event: String?, extras: Bundle?) {
            ...
            when(event) {
                NETWORK_ERROR -> _networkError.postValue(
                    Event(
                        Resource.error(
                            "Couldn't connect to server, please check internet connection",
                            null
                        )
                    )
                )
